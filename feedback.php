...
if (!isset($_SESSION['tenant_id']) || !isset($_SESSION['lan_id']) || !isset($_SESSION['ten'])){
  die('Access Denied');
}
...
<form method="POST">
 ...
 <input style="margin-right: 5px" class="fed" type="submit" name="cancel" value="Back" style="width: 150px;">
</form>
<br><br><br>
</div>
